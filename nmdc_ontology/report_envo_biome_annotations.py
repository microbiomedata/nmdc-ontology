...
@click.command()
@click.option('--tsv-output', 'tsv_output_file', default="assets/report_envo_biome_annotations.tsv",
              help="Output TSV file path")
@click.option('--yaml-output', 'yaml_output_file', default="assets/report_envo_biome_annotations.yaml",
              help="Output YAML file path")
@click.option('--endpoint', default="http://3.236.215.220/repositories/nmdc-knowledgegraph", help="SPARQL endpoint URL")
def main(tsv_output_file: str, yaml_output_file: str, endpoint: str):
    query = """
