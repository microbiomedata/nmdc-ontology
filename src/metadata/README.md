 ...
 * [nmdco.yml](nmdco.yml)
     * Determines how your purl.obolibrary.org/obo/nmdco/ redirects will be handled
     ...
     * Paste in the contents of [nmdco.yml](nmdco.yml)
 ...
 * [nmdco.md](nmdco.md)
     ...
     * Paste in the contents of [nmdco.md](nmdco.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
